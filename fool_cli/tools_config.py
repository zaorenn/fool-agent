...
CONFIGURABLE_TOOLSETS = [
    ...
    ("antigravity",     "🪐 Google Antigravity",        "delegate prompts, tasks, and multi-turn runs to Antigravity"),
...
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "video", "video_gen", "x_search", "a2a", "rapor", "computer_use"}
