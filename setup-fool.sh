...
# ============================================================================
echo -e "${CYAN}→${NC} Setting up fool command..."

FOOL_BIN="$SCRIPT_DIR/venv/bin/fool"
COMMAND_LINK_DIR="$(get_command_link_dir)"
COMMAND_LINK_DISPLAY_DIR="$(get_command_link_display_dir)"
mkdir -p "$COMMAND_LINK_DIR"
ln -sf "$FOOL_BIN" "$COMMAND_LINK_DIR/fool"
ln -sf "$FOOL_BIN" "$COMMAND_LINK_DIR/hermes"
echo -e "${GREEN}✓${NC} Symlinked fool → $COMMAND_LINK_DISPLAY_DIR/fool"
...
# ============================================================================
# Seed bundled skills into ~/.fool/skills/
# ============================================================================

FOOL_SKILLS_DIR="${FOOL_HOME:-$HOME/.fool}/skills"
mkdir -p "$FOOL_SKILLS_DIR"

echo ""
echo "Syncing bundled skills to ~/.fool/skills/ ..."
